# Spec: Transaction Proofs List

## Purpose

Defines requirements for displaying a list of uploaded transaction proofs (bukti transaksi) on the finance page, accessible to all logged-in members.
