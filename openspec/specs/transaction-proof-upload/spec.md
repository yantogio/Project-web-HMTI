# Spec: Transaction Proof Upload

## Purpose

Defines requirements for uploading transaction proof files (bukti transaksi) to Google Drive when recording income and expense transactions. Covers the data model changes, form-level upload behavior per transaction category, and backend upload mechanics.
