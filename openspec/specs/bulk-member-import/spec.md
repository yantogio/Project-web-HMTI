# Capability: Bulk Member Import

## Purpose

Memungkinkan pengurus untuk mengimport banyak anggota sekaligus melalui file Excel, mengurangi entri data manual satu per satu.
