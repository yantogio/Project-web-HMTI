...
Defines requirements for JWT secret configuration so that token signing and verification always use the same environment-provided key, and misconfiguration is caught at startup instead of surfacing as runtime 401 errors.
