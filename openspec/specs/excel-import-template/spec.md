# Capability: Excel Import Template

## Purpose

Menyediakan template Excel yang dapat didownload agar pengguna memiliki format yang benar saat menyiapkan data import anggota massal.
